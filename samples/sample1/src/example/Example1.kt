...
fun main(args: Array<String>): Unit {
	...
	//Logger("BaseEventLoopNative").level = Logger.Level.TRACE
	//Logger("EventLoop").level = Logger.Level.TRACE
	...
	//Logger("coroutine").level = Logger.Level.TRACE
	//println(Logger.defaultLevel)
	//println(Logger("EventLoop").level)
	Korge(MyModule)
}
