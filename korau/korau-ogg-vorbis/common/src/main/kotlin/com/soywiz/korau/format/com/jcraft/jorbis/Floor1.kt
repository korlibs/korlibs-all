	...
	override fun inverse1(vb: Block, ii: Any, memo: Any?): Any? {
		...
		if (vb.opb.read(1) == 1) {
			...
			for (i in 2..look.posts - 1) {
				val predicted = render_point(info!!.postlist!![look.loneighbor!![i - 2]],
