...
fun SyncStream.readGusPatch(): SoundFont {
	...
	val voices = readU8()
	val channels = readU8()
	val waveforms = readS16_le()
	val masterVolume = readS16_le()
	val dataSize = readS32_le()
	readBytesExact(36) // reserved
	val instrumentId = readS16_le()
	val instrumentName = readStringz(16, ASCII)
	val instrumentSize = readS32_le()
	val layers = readU8()
	readBytesExact(40) // reserved
	val layerdup = readU8()
	val layer = readU8()
	val layerSize = readS32_le()
	val nsamples = readU8()
	readBytesExact(40) // reserved
	for (n in 0 until nsamples) {
		val name = readStringz(7, ASCII)
		val fractions = readU8()
		val sampleDataSize = readS32_le()
		val loopStart = readS32_le()
		val loopEnd = readS32_le()
		val sampleRate = readU16_le()
		val lowFreq = readS32_le()
		val highFreq = readS32_le()
		val rootFreq = readS32_le()
		val tune = readS16_le()
		val panning = readU8()
		...
		val scaleFreq = readS16_le()
		val scaleFactor = readS16_le()
		readBytesExact(36) // reserved
