...
class JvmKmlGl : KmlGl() {
    ...
    override fun bufferData(target: Int, size: Int, data: KmlNativeBuffer, usage: Int): Unit = glBufferData(target, size.toLong(), data.nioBuffer, usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: KmlNativeBuffer): Unit = glBufferSubData(target, offset.toLong(), size.toLong(), data.nioBuffer)
    ...
    override fun deleteBuffers(n: Int, items: KmlNativeBuffer): Unit = glDeleteBuffers(n, items.nioBuffer)
    override fun deleteFramebuffers(n: Int, items: KmlNativeBuffer): Unit = glDeleteFramebuffers(n, items.nioBuffer)
    override fun deleteProgram(program: Int): Unit = glDeleteProgram(program)
    override fun deleteRenderbuffers(n: Int, items: KmlNativeBuffer): Unit = glDeleteRenderbuffers(n, items.nioBuffer)
    override fun deleteShader(shader: Int): Unit = glDeleteShader(shader)
    override fun deleteTextures(n: Int, items: KmlNativeBuffer): Unit = glDeleteTextures(n, items.nioBuffer)
    ...
    override fun genBuffers(n: Int, buffers: KmlNativeBuffer): Unit = glGenBuffers(n, buffers.nioBuffer)
    override fun generateMipmap(target: Int): Unit = glGenerateMipmap(target)
    override fun genFramebuffers(n: Int, framebuffers: KmlNativeBuffer): Unit = glGenFramebuffers(n, framebuffers.nioBuffer)
    override fun genRenderbuffers(n: Int, renderbuffers: KmlNativeBuffer): Unit = glGenRenderbuffers(n, renderbuffers.nioBuffer)
    override fun genTextures(n: Int, textures: KmlNativeBuffer): Unit = glGenTextures(n, textures.nioBuffer)
    override fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: KmlNativeBuffer, size: KmlNativeBuffer, type: KmlNativeBuffer, name: KmlNativeBuffer): Unit = glGetActiveAttrib(program, index, bufSize, length.nioBuffer, size.nioBuffer, type.nioBuffer, name.nioBuffer)
    override fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: KmlNativeBuffer, size: KmlNativeBuffer, type: KmlNativeBuffer, name: KmlNativeBuffer): Unit = glGetActiveUniform(program, index, bufSize, length.nioBuffer, size.nioBuffer, type.nioBuffer, name.nioBuffer)
    override fun getAttachedShaders(program: Int, maxCount: Int, count: KmlNativeBuffer, shaders: KmlNativeBuffer): Unit = glGetAttachedShaders(program, maxCount, count.nioBuffer, shaders.nioBuffer)
    ...
    override fun getBufferParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetBufferParameteriv(target, pname, params.nioBuffer)
    override fun getError(): Int = glGetError()
    override fun getFloatv(pname: Int, data: KmlNativeBuffer): Unit = glGetFloatv(pname, data.nioBuffer)
    override fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetFramebufferAttachmentParameteriv(target, attachment, pname, params.nioBuffer)
    override fun getIntegerv(pname: Int, data: KmlNativeBuffer): Unit = glGetIntegerv(pname, data.nioBuffer)
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: KmlNativeBuffer, infoLog: KmlNativeBuffer): Unit = glGetProgramInfoLog(program, bufSize, length.nioBuffer, infoLog.nioBuffer)
    override fun getRenderbufferParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetRenderbufferParameteriv(target, pname, params.nioBuffer)
    override fun getProgramiv(program: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetProgramiv(program, pname, params.nioBuffer)
    override fun getShaderiv(shader: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetShaderiv(shader, pname, params.nioBuffer)
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: KmlNativeBuffer, infoLog: KmlNativeBuffer): Unit = glGetShaderInfoLog(shader, bufSize, length.nioBuffer, infoLog.nioBuffer)
    override fun getShaderPrecisionFormat(shadertype: Int, precisiontype: Int, range: KmlNativeBuffer, precision: KmlNativeBuffer): Unit = glGetShaderPrecisionFormat(shadertype, precisiontype, range.nioBuffer, precision.nioBuffer)
    override fun getShaderSource(shader: Int, bufSize: Int, length: KmlNativeBuffer, source: KmlNativeBuffer): Unit = glGetShaderSource(shader, bufSize, length.nioBuffer, source.nioBuffer)
    override fun getString(name: Int): String = glGetString(name)
    override fun getTexParameterfv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetTexParameterfv(target, pname, params.nioBuffer)
    override fun getTexParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetTexParameteriv(target, pname, params.nioBuffer)
    override fun getUniformfv(program: Int, location: Int, params: KmlNativeBuffer): Unit = glGetUniformfv(program, location, params.nioBuffer)
    override fun getUniformiv(program: Int, location: Int, params: KmlNativeBuffer): Unit = glGetUniformiv(program, location, params.nioBuffer)
    override fun getVertexAttribfv(index: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetVertexAttribfv(index, pname, params.nioBuffer)
    override fun getVertexAttribiv(index: Int, pname: Int, params: KmlNativeBuffer): Unit = glGetVertexAttribiv(index, pname, params.nioBuffer)
    override fun getVertexAttribPointerv(index: Int, pname: Int, pointer: KmlNativeBuffer): Unit = glGetVertexAttribPointerv(index, pname, pointer.nioBuffer)
    ...
    override fun shaderBinary(count: Int, shaders: KmlNativeBuffer, binaryformat: Int, binary: KmlNativeBuffer, length: Int): Unit = glShaderBinary(count, shaders.nioBuffer, binaryformat, binary.nioBuffer, length)
    ...
    override fun texImage2D(target: Int, level: Int, internalformat: Int, format: Int, type: Int, data: KmlGlNativeImageData): Unit = glTexImage2D(target, level, internalformat, data.width, data.height, 0, format, type, (data as BufferedImageKmlNativeImageData).buffer)
    override fun texParameterf(target: Int, pname: Int, param: Float): Unit = glTexParameterf(target, pname, param)
    override fun texParameterfv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = glTexParameterfv(target, pname, params.nioBuffer)
    override fun texParameteri(target: Int, pname: Int, param: Int): Unit = glTexParameteri(target, pname, param)
    override fun texParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = glTexParameteriv(target, pname, params.nioBuffer)
    ...
    override fun uniform1fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform1fv(location, count, value.nioBuffer)
    override fun uniform1i(location: Int, v0: Int): Unit = glUniform1i(location, v0)
    override fun uniform1iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform1iv(location, count, value.nioBuffer)
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = glUniform2f(location, v0, v1)
    override fun uniform2fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform2fv(location, count, value.nioBuffer)
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = glUniform2i(location, v0, v1)
    override fun uniform2iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform2iv(location, count, value.nioBuffer)
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = glUniform3f(location, v0, v1, v2)
    override fun uniform3fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform3fv(location, count, value.nioBuffer)
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = glUniform3i(location, v0, v1, v2)
    override fun uniform3iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform3iv(location, count, value.nioBuffer)
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = glUniform4f(location, v0, v1, v2, v3)
    override fun uniform4fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform4fv(location, count, value.nioBuffer)
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = glUniform4i(location, v0, v1, v2, v3)
    override fun uniform4iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = glUniform4iv(location, count, value.nioBuffer)
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit = glUniformMatrix2fv(location, count, transpose, value.nioBuffer)
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit = glUniformMatrix3fv(location, count, transpose, value.nioBuffer)
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit = glUniformMatrix4fv(location, count, transpose, value.nioBuffer)
    ...
    override fun vertexAttrib1fv(index: Int, v: KmlNativeBuffer): Unit = glVertexAttrib1fv(index, v.nioBuffer)
    override fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit = glVertexAttrib2f(index, x, y)
    override fun vertexAttrib2fv(index: Int, v: KmlNativeBuffer): Unit = glVertexAttrib2fv(index, v.nioBuffer)
    override fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit = glVertexAttrib3f(index, x, y, z)
    override fun vertexAttrib3fv(index: Int, v: KmlNativeBuffer): Unit = glVertexAttrib3fv(index, v.nioBuffer)
    override fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit = glVertexAttrib4f(index, x, y, z, w)
    override fun vertexAttrib4fv(index: Int, v: KmlNativeBuffer): Unit = glVertexAttrib4fv(index, v.nioBuffer)
