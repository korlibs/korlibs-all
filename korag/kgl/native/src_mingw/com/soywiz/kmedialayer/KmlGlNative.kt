...
class KmlGlNative : KmlGl() {
    ...
    override fun bufferData(target: Int, size: Int, data: MemBuffer, usage: Int): Unit = glBufferData(target, size.narrowSize(), data.unsafeAddress().uncheckedCast(), usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: MemBuffer): Unit = glBufferSubData(target, offset.narrowSize(), size.narrowSize(), data.unsafeAddress().uncheckedCast())
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: MemBuffer): Unit = glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data.unsafeAddress().uncheckedCast())
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: MemBuffer): Unit = glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data.unsafeAddress().uncheckedCast())
    ...
    override fun deleteBuffers(n: Int, items: MemBuffer): Unit = glDeleteBuffers(n, items.unsafeAddress().uncheckedCast())
    override fun deleteFramebuffers(n: Int, items: MemBuffer): Unit = glDeleteFramebuffers(n, items.unsafeAddress().uncheckedCast())
    override fun deleteProgram(program: Int): Unit = glDeleteProgram(program)
    override fun deleteRenderbuffers(n: Int, items: MemBuffer): Unit = glDeleteRenderbuffers(n, items.unsafeAddress().uncheckedCast())
    override fun deleteShader(shader: Int): Unit = glDeleteShader(shader)
    override fun deleteTextures(n: Int, items: MemBuffer): Unit = glDeleteTextures(n, items.unsafeAddress().uncheckedCast())
    ...
    override fun genBuffers(n: Int, buffers: MemBuffer): Unit = glGenBuffers(n, buffers.unsafeAddress().uncheckedCast())
    override fun generateMipmap(target: Int): Unit = glGenerateMipmap(target)
    override fun genFramebuffers(n: Int, framebuffers: MemBuffer): Unit = glGenFramebuffers(n, framebuffers.unsafeAddress().uncheckedCast())
    override fun genRenderbuffers(n: Int, renderbuffers: MemBuffer): Unit = glGenRenderbuffers(n, renderbuffers.unsafeAddress().uncheckedCast())
    override fun genTextures(n: Int, textures: MemBuffer): Unit = glGenTextures(n, textures.unsafeAddress().uncheckedCast())
    override fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: MemBuffer, size: MemBuffer, type: MemBuffer, name: MemBuffer): Unit = glGetActiveAttrib(program, index, bufSize, length.unsafeAddress().uncheckedCast(), size.unsafeAddress().uncheckedCast(), type.unsafeAddress().uncheckedCast(), name.unsafeAddress().uncheckedCast())
    override fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: MemBuffer, size: MemBuffer, type: MemBuffer, name: MemBuffer): Unit = glGetActiveUniform(program, index, bufSize, length.unsafeAddress().uncheckedCast(), size.unsafeAddress().uncheckedCast(), type.unsafeAddress().uncheckedCast(), name.unsafeAddress().uncheckedCast())
    override fun getAttachedShaders(program: Int, maxCount: Int, count: MemBuffer, shaders: MemBuffer): Unit = glGetAttachedShaders(program, maxCount, count.unsafeAddress().uncheckedCast(), shaders.unsafeAddress().uncheckedCast())
    ...
    override fun getBooleanv(pname: Int, data: MemBuffer): Unit = glGetBooleanv(pname, data.unsafeAddress().uncheckedCast())
    override fun getBufferParameteriv(target: Int, pname: Int, params: MemBuffer): Unit = glGetBufferParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun getError(): Int = glGetError()
    override fun getFloatv(pname: Int, data: MemBuffer): Unit = glGetFloatv(pname, data.unsafeAddress().uncheckedCast())
    override fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: MemBuffer): Unit = glGetFramebufferAttachmentParameteriv(target, attachment, pname, params.unsafeAddress().uncheckedCast())
    override fun getIntegerv(pname: Int, data: MemBuffer): Unit = glGetIntegerv(pname, data.unsafeAddress().uncheckedCast())
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: MemBuffer, infoLog: MemBuffer): Unit = glGetProgramInfoLog(program, bufSize, length.unsafeAddress().uncheckedCast(), infoLog.unsafeAddress().uncheckedCast())
    override fun getRenderbufferParameteriv(target: Int, pname: Int, params: MemBuffer): Unit = glGetRenderbufferParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun getProgramiv(program: Int, pname: Int, params: MemBuffer): Unit = glGetProgramiv(program, pname, params.unsafeAddress().uncheckedCast())
    override fun getShaderiv(shader: Int, pname: Int, params: MemBuffer): Unit = glGetShaderiv(shader, pname, params.unsafeAddress().uncheckedCast())
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: MemBuffer, infoLog: MemBuffer): Unit = glGetShaderInfoLog(shader, bufSize, length.unsafeAddress().uncheckedCast(), infoLog.unsafeAddress().uncheckedCast())
    override fun getShaderPrecisionFormat(shadertype: Int, precisiontype: Int, range: MemBuffer, precision: MemBuffer): Unit = Unit
    override fun getShaderSource(shader: Int, bufSize: Int, length: MemBuffer, source: MemBuffer): Unit = glGetShaderSource(shader, bufSize, length.unsafeAddress().uncheckedCast(), source.unsafeAddress().uncheckedCast())
    override fun getString(name: Int): String = (glGetString(name))?.toKString() ?: ""
    override fun getTexParameterfv(target: Int, pname: Int, params: MemBuffer): Unit = glGetTexParameterfv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun getTexParameteriv(target: Int, pname: Int, params: MemBuffer): Unit = glGetTexParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun getUniformfv(program: Int, location: Int, params: MemBuffer): Unit = glGetUniformfv(program, location, params.unsafeAddress().uncheckedCast())
    override fun getUniformiv(program: Int, location: Int, params: MemBuffer): Unit = glGetUniformiv(program, location, params.unsafeAddress().uncheckedCast())
    override fun getVertexAttribfv(index: Int, pname: Int, params: MemBuffer): Unit = glGetVertexAttribfv(index, pname, params.unsafeAddress().uncheckedCast())
    override fun getVertexAttribiv(index: Int, pname: Int, params: MemBuffer): Unit = glGetVertexAttribiv(index, pname, params.unsafeAddress().uncheckedCast())
    override fun getVertexAttribPointerv(index: Int, pname: Int, pointer: MemBuffer): Unit = glGetVertexAttribPointerv(index, pname, pointer.unsafeAddress().uncheckedCast())
    ...
    override fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: MemBuffer): Unit = glReadPixels(x, y, width, height, format, type, pixels.unsafeAddress().uncheckedCast())
    ...
    override fun shaderBinary(count: Int, shaders: MemBuffer, binaryformat: Int, binary: MemBuffer, length: Int): Unit = throw KmlGlException("shaderBinary not implemented in Native")
    ...
    override fun texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: MemBuffer): Unit = glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels.unsafeAddress().uncheckedCast())
    override fun texImage2D(target: Int, level: Int, internalformat: Int, format: Int, type: Int, data: Any): Unit = (data as KmlNativeNativeImageData).data.usePinned { dataPin -> glTexImage2D(target, level, internalformat, data.width, data.height, 0, format, type, dataPin.addressOf(0).uncheckedCast()) }
    override fun texParameterf(target: Int, pname: Int, param: Float): Unit = glTexParameterf(target, pname, param)
    override fun texParameterfv(target: Int, pname: Int, params: MemBuffer): Unit = glTexParameterfv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun texParameteri(target: Int, pname: Int, param: Int): Unit = glTexParameteri(target, pname, param)
    override fun texParameteriv(target: Int, pname: Int, params: MemBuffer): Unit = glTexParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: MemBuffer): Unit = glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels.unsafeAddress().uncheckedCast())
    override fun uniform1f(location: Int, v0: Float): Unit = glUniform1f(location, v0)
    override fun uniform1fv(location: Int, count: Int, value: MemBuffer): Unit = glUniform1fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform1i(location: Int, v0: Int): Unit = glUniform1i(location, v0)
    override fun uniform1iv(location: Int, count: Int, value: MemBuffer): Unit = glUniform1iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = glUniform2f(location, v0, v1)
    override fun uniform2fv(location: Int, count: Int, value: MemBuffer): Unit = glUniform2fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = glUniform2i(location, v0, v1)
    override fun uniform2iv(location: Int, count: Int, value: MemBuffer): Unit = glUniform2iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = glUniform3f(location, v0, v1, v2)
    override fun uniform3fv(location: Int, count: Int, value: MemBuffer): Unit = glUniform3fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = glUniform3i(location, v0, v1, v2)
    override fun uniform3iv(location: Int, count: Int, value: MemBuffer): Unit = glUniform3iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = glUniform4f(location, v0, v1, v2, v3)
    override fun uniform4fv(location: Int, count: Int, value: MemBuffer): Unit = glUniform4fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = glUniform4i(location, v0, v1, v2, v3)
    override fun uniform4iv(location: Int, count: Int, value: MemBuffer): Unit = glUniform4iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: MemBuffer): Unit = glUniformMatrix2fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: MemBuffer): Unit = glUniformMatrix3fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: MemBuffer): Unit = glUniformMatrix4fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())
    ...
    override fun vertexAttrib1fv(index: Int, v: MemBuffer): Unit = glVertexAttrib1fv(index, v.unsafeAddress().uncheckedCast())
    override fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit = glVertexAttrib2f(index, x, y)
    override fun vertexAttrib2fv(index: Int, v: MemBuffer): Unit = glVertexAttrib2fv(index, v.unsafeAddress().uncheckedCast())
    override fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit = glVertexAttrib3f(index, x, y, z)
    override fun vertexAttrib3fv(index: Int, v: MemBuffer): Unit = glVertexAttrib3fv(index, v.unsafeAddress().uncheckedCast())
    override fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit = glVertexAttrib4f(index, x, y, z, w)
    override fun vertexAttrib4fv(index: Int, v: MemBuffer): Unit = glVertexAttrib4fv(index, v.unsafeAddress().uncheckedCast())
