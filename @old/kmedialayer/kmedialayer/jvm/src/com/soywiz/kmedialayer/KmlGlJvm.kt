...
class JvmKmlGl : KmlGl() {
	...
	override fun bufferData(target: Int, size: Int, data: KmlNativeBuffer, usage: Int): Unit =
		glBufferData(target, data.nioBuffer, usage)

	override fun bufferSubData(target: Int, offset: Int, size: Int, data: KmlNativeBuffer): Unit =
		glBufferSubData(target, offset.toLong(), data.nioBuffer)
	...
	): Unit = glCompressedTexImage2D(target, level, internalformat, width, height, border, data.nioByteBuffer)
	...
	override fun compressedTexSubImage2D(
		...
		imageSize: Int,
		data: KmlNativeBuffer
	): Unit = glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, data.nioByteBuffer)
	...
	override fun drawElements(mode: Int, count: Int, type: Int, indices: Int): Unit =
		glDrawElements(mode, count, type, indices.toLong())
	...
	override fun genFramebuffers(n: Int, framebuffers: KmlNativeBuffer): Unit =
		glGenFramebuffers(framebuffers.nioIntBuffer)

	override fun genRenderbuffers(n: Int, renderbuffers: KmlNativeBuffer): Unit =
		glGenRenderbuffers(renderbuffers.nioIntBuffer)
	...
	override fun getActiveAttrib(
		...
		glGetActiveAttrib(program, index, length.nioIntBuffer, size.nioIntBuffer, type.nioIntBuffer, name.nioBuffer)
	...
	override fun getActiveUniform(
		...
		glGetActiveUniform(program, index, length.nioIntBuffer, size.nioIntBuffer, type.nioIntBuffer, name.nioBuffer)
	...
	): Unit = glGetAttachedShaders(program, count.nioIntBuffer, shaders.nioIntBuffer)
	...
	override fun getBufferParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glGetBufferParameteriv(target, pname, params.nioIntBuffer)
	...
	): Unit = glGetFramebufferAttachmentParameteriv(target, attachment, pname, params.nioIntBuffer)
	...
	): Unit = glGetShaderPrecisionFormat(shadertype, precisiontype, range.nioIntBuffer, precision.nioIntBuffer)

	override fun getShaderSource(shader: Int, bufSize: Int, length: KmlNativeBuffer, source: KmlNativeBuffer): Unit =
		glGetShaderSource(shader, length.nioIntBuffer, source.nioBuffer)
	...
	): Unit = glReadPixels(x, y, width, height, format, type, pixels.nioBuffer)
	...
	override fun shaderBinary(
		...
		length: Int
	): Unit = glShaderBinary(shaders.nioIntBuffer, binaryformat, binary.nioBuffer)
	...
	override fun texImage2D(
		...
		type: Int,
		pixels: KmlNativeBuffer
	): Unit = glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels.nioBuffer)
	...
	override fun texImage2D(
		...
		format,
		type,
		(data as BufferedImageKmlNativeImageData).buffer
	)
	...
	override fun texParameterfv(target: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glTexParameterfv(target, pname, params.nioFloatBuffer)
	...
	override fun texParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glTexParameteriv(target, pname, params.nioIntBuffer)
	...
	override fun texSubImage2D(
		...
		type: Int,
		pixels: KmlNativeBuffer
	): Unit = glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels.nioBuffer)
	...
	override fun uniform1fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform1fv(location, value.nioFloatBuffer)
	...
	override fun uniform1iv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform1iv(location, value.nioIntBuffer)
	...
	override fun uniform2fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform2fv(location, value.nioFloatBuffer)
	...
	override fun uniform2iv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform2iv(location, value.nioIntBuffer)
	...
	override fun uniform3fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform3fv(location, value.nioFloatBuffer)
	...
	override fun uniform3iv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform3iv(location, value.nioIntBuffer)
	...
	override fun uniform4fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform4fv(location, value.nioFloatBuffer)
	...
	override fun vertexAttribPointer(
		...
		stride: Int,
		pointer: Int
	): Unit = glVertexAttribPointer(index, size, type, normalized, stride, pointer.toLong())
