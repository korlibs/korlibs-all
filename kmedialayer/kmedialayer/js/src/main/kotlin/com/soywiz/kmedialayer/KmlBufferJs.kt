...
val KmlNativeBuffer.arrayBuffer: ArrayBuffer
	get() = (this as KmlNativeBuffer).arrayBuffer
@Suppress("USELESS_CAST")
val KmlNativeBuffer.arrayByte: Int8Array
	get() = (this as KmlNativeBuffer).arrayByte
@Suppress("USELESS_CAST")
val KmlNativeBuffer.arrayUByte: Uint8Array
	get() = (this as KmlNativeBuffer).arrayUByte
@Suppress("USELESS_CAST")
val KmlNativeBuffer.arrayShort: Int16Array
	get() = (this as KmlNativeBuffer).arrayShort
@Suppress("USELESS_CAST")
val KmlNativeBuffer.arrayInt: Int32Array
	get() = (this as KmlNativeBuffer).arrayInt
@Suppress("USELESS_CAST")
val KmlNativeBuffer.arrayFloat: Float32Array
	get() = (this as KmlNativeBuffer).arrayFloat
