...
object KmlGlDummy : KmlGl() {
    ...
    override fun bufferData(target: Int, size: Int, data: KmlNativeBuffer, usage: Int): Unit = Unit
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: KmlNativeBuffer): Unit = Unit
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: KmlNativeBuffer): Unit = Unit
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: KmlNativeBuffer): Unit = Unit
    ...
    override fun deleteBuffers(n: Int, items: KmlNativeBuffer): Unit = Unit
    override fun deleteFramebuffers(n: Int, items: KmlNativeBuffer): Unit = Unit
    override fun deleteProgram(program: Int): Unit = Unit
    override fun deleteRenderbuffers(n: Int, items: KmlNativeBuffer): Unit = Unit
    override fun deleteShader(shader: Int): Unit = Unit
    override fun deleteTextures(n: Int, items: KmlNativeBuffer): Unit = Unit
    ...
    override fun genBuffers(n: Int, buffers: KmlNativeBuffer): Unit = Unit
    override fun generateMipmap(target: Int): Unit = Unit
    override fun genFramebuffers(n: Int, framebuffers: KmlNativeBuffer): Unit = Unit
    override fun genRenderbuffers(n: Int, renderbuffers: KmlNativeBuffer): Unit = Unit
    override fun genTextures(n: Int, textures: KmlNativeBuffer): Unit = Unit
    override fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: KmlNativeBuffer, size: KmlNativeBuffer, type: KmlNativeBuffer, name: KmlNativeBuffer): Unit = Unit
    override fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: KmlNativeBuffer, size: KmlNativeBuffer, type: KmlNativeBuffer, name: KmlNativeBuffer): Unit = Unit
    override fun getAttachedShaders(program: Int, maxCount: Int, count: KmlNativeBuffer, shaders: KmlNativeBuffer): Unit = Unit
    ...
    override fun getBooleanv(pname: Int, data: KmlNativeBuffer): Unit = Unit
    override fun getBufferParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getError(): Int = 0
    override fun getFloatv(pname: Int, data: KmlNativeBuffer): Unit = Unit
    override fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getIntegerv(pname: Int, data: KmlNativeBuffer): Unit = Unit
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: KmlNativeBuffer, infoLog: KmlNativeBuffer): Unit = Unit
    override fun getRenderbufferParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getProgramiv(program: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getShaderiv(shader: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: KmlNativeBuffer, infoLog: KmlNativeBuffer): Unit = Unit
    ...
    override fun getShaderSource(shader: Int, bufSize: Int, length: KmlNativeBuffer, source: KmlNativeBuffer): Unit = Unit
    override fun getString(name: Int): String = ""
    override fun getTexParameterfv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getTexParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getUniformfv(program: Int, location: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getUniformiv(program: Int, location: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getVertexAttribfv(index: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getVertexAttribiv(index: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun getVertexAttribPointerv(index: Int, pname: Int, pointer: KmlNativeBuffer): Unit = Unit
    ...
    override fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: KmlNativeBuffer): Unit = Unit
    ...
    override fun shaderBinary(count: Int, shaders: KmlNativeBuffer, binaryformat: Int, binary: KmlNativeBuffer, length: Int): Unit = Unit
    ...
    override fun texParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit = Unit
    override fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: KmlNativeBuffer): Unit = Unit
    override fun uniform1f(location: Int, v0: Float): Unit = Unit
    override fun uniform1fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniform1i(location: Int, v0: Int): Unit = Unit
    override fun uniform1iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = Unit
    override fun uniform2fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = Unit
    override fun uniform2iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = Unit
    override fun uniform3fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = Unit
    override fun uniform3iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = Unit
    override fun uniform4fv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = Unit
    override fun uniform4iv(location: Int, count: Int, value: KmlNativeBuffer): Unit = Unit
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit = Unit
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit = Unit
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit = Unit
    ...
    override fun vertexAttrib1fv(index: Int, v: KmlNativeBuffer): Unit = Unit
    override fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit = Unit
    override fun vertexAttrib2fv(index: Int, v: KmlNativeBuffer): Unit = Unit
    override fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit = Unit
    override fun vertexAttrib3fv(index: Int, v: KmlNativeBuffer): Unit = Unit
    override fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit = Unit
    override fun vertexAttrib4fv(index: Int, v: KmlNativeBuffer): Unit = Unit
