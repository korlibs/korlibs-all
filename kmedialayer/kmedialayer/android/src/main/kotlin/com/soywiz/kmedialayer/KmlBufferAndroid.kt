...
actual class KmlNativeBuffer constructor(val baseByteBuffer: ByteBuffer) {
    ...
    actual constructor(size: Int) : this(ByteBuffer.allocateDirect(kmlInternalRoundUp(size, 8)).order(ByteOrder.nativeOrder()))
...
@Suppress("USELESS_CAST") val KmlNativeBuffer.nioBuffer: ByteBuffer get() = (this as KmlNativeBuffer).byteBuffer
@Suppress("USELESS_CAST") val KmlNativeBuffer.nioByteBuffer: ByteBuffer get() = (this as KmlNativeBuffer).byteBuffer
@Suppress("USELESS_CAST") val KmlNativeBuffer.nioShortBuffer: ShortBuffer get() = (this as KmlNativeBuffer).shortBuffer
@Suppress("USELESS_CAST") val KmlNativeBuffer.nioIntBuffer: IntBuffer get() = (this as KmlNativeBuffer).intBuffer
@Suppress("USELESS_CAST") val KmlNativeBuffer.nioFloatBuffer: FloatBuffer get() = (this as KmlNativeBuffer).floatBuffer
