...
class KmlGlNative : KmlGl() {
	...
	override fun bindAttribLocation(program: Int, index: Int, name: String): Unit =
		memScoped { glBindAttribLocation(program, index, (name).cstr.getPointer(this@memScoped)) }
	...
	override fun bufferData(target: Int, size: Int, data: KmlNativeBuffer, usage: Int): Unit =
		glBufferData(target, size.narrowSize(), data.unsafeAddress().uncheckedCast(), usage)

	override fun bufferSubData(target: Int, offset: Int, size: Int, data: KmlNativeBuffer): Unit =
		glBufferSubData(target, offset.narrowSize(), size.narrowSize(), data.unsafeAddress().uncheckedCast())
	...
	override fun colorMask(red: Boolean, green: Boolean, blue: Boolean, alpha: Boolean): Unit =
		glColorMask(red.narrow(), green.narrow(), blue.narrow(), alpha.narrow())
	...
	override fun compressedTexImage2D(
		...
		border,
		imageSize,
		data.unsafeAddress().uncheckedCast()
	)
	...
	override fun compressedTexSubImage2D(
		...
		imageSize: Int,
		data: KmlNativeBuffer
	): Unit = glCompressedTexSubImage2D(
		target,
		level,
		xoffset,
		yoffset,
	...
	override fun copyTexImage2D(
		...
		height: Int,
		border: Int
	): Unit = glCopyTexImage2D(target, level, internalformat, x, y, width, height, border)
	...
	override fun copyTexSubImage2D(
		...
		width: Int,
		height: Int
	): Unit = glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width, height)
	...
	override fun deleteBuffers(n: Int, items: KmlNativeBuffer): Unit =
		glDeleteBuffers(n, items.unsafeAddress().uncheckedCast())

	override fun deleteFramebuffers(n: Int, items: KmlNativeBuffer): Unit =
		glDeleteFramebuffers(n, items.unsafeAddress().uncheckedCast())
	...
	override fun deleteRenderbuffers(n: Int, items: KmlNativeBuffer): Unit =
		glDeleteRenderbuffers(n, items.unsafeAddress().uncheckedCast())
	...
	override fun deleteTextures(n: Int, items: KmlNativeBuffer): Unit =
		glDeleteTextures(n, items.unsafeAddress().uncheckedCast())
	...
	override fun drawElements(mode: Int, count: Int, type: Int, indices: Int): Unit =
		glDrawElements(mode, count, type, indices.uncheckedCast())
	...
	override fun framebufferRenderbuffer(
		...
		renderbuffer: Int
	): Unit = glFramebufferRenderbuffer(target, attachment, renderbuffertarget, renderbuffer)
	...
	override fun genBuffers(n: Int, buffers: KmlNativeBuffer): Unit =
		glGenBuffers(n, buffers.unsafeAddress().uncheckedCast())
	...
	override fun genFramebuffers(n: Int, framebuffers: KmlNativeBuffer): Unit =
		glGenFramebuffers(n, framebuffers.unsafeAddress().uncheckedCast())

	override fun genRenderbuffers(n: Int, renderbuffers: KmlNativeBuffer): Unit =
		glGenRenderbuffers(n, renderbuffers.unsafeAddress().uncheckedCast())

	override fun genTextures(n: Int, textures: KmlNativeBuffer): Unit =
		glGenTextures(n, textures.unsafeAddress().uncheckedCast())
	...
	): Unit = glGetActiveAttrib(
		program,
		index,
		bufSize,
		length.unsafeAddress().uncheckedCast(),
	...
	): Unit = glGetAttachedShaders(
		program,
		maxCount,
		count.unsafeAddress().uncheckedCast(),
		shaders.unsafeAddress().uncheckedCast()
	)

	override fun getAttribLocation(program: Int, name: String): Int =
		memScoped { glGetAttribLocation(program, (name).cstr.getPointer(this@memScoped)) }

	override fun getUniformLocation(program: Int, name: String): Int =
		memScoped { glGetUniformLocation(program, (name).cstr.getPointer(this@memScoped)) }

	override fun getBooleanv(pname: Int, data: KmlNativeBuffer): Unit =
		glGetBooleanv(pname, data.unsafeAddress().uncheckedCast())

	override fun getBufferParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glGetBufferParameteriv(target, pname, params.unsafeAddress().uncheckedCast())

	override fun getError(): Int = glGetError()
	override fun getFloatv(pname: Int, data: KmlNativeBuffer): Unit =
		glGetFloatv(pname, data.unsafeAddress().uncheckedCast())
	...
	): Unit = glGetFramebufferAttachmentParameteriv(target, attachment, pname, params.unsafeAddress().uncheckedCast())

	override fun getIntegerv(pname: Int, data: KmlNativeBuffer): Unit =
		glGetIntegerv(pname, data.unsafeAddress().uncheckedCast())
	...
	): Unit = glGetProgramInfoLog(
		program,
		bufSize,
		length.unsafeAddress().uncheckedCast(),
		infoLog.unsafeAddress().uncheckedCast()
	)

	override fun getRenderbufferParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glGetRenderbufferParameteriv(target, pname, params.unsafeAddress().uncheckedCast())

	override fun getProgramiv(program: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glGetProgramiv(program, pname, params.unsafeAddress().uncheckedCast())

	override fun getShaderiv(shader: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glGetShaderiv(shader, pname, params.unsafeAddress().uncheckedCast())
	...
	override fun getShaderSource(shader: Int, bufSize: Int, length: KmlNativeBuffer, source: KmlNativeBuffer): Unit =
		glGetShaderSource(
			...
			bufSize,
			length.unsafeAddress().uncheckedCast(),
			source.unsafeAddress().uncheckedCast()
		)
	...
	): Unit = glReadPixels(x, y, width, height, format, type, pixels.unsafeAddress().uncheckedCast())
	...
	override fun shaderBinary(
		...
		length: Int
	): Unit = throw KmlGlException("shaderBinary not implemented in Native")

	override fun shaderSource(shader: Int, string: String): Unit = memScoped {
		run {
			memScoped {
	...
	override fun texImage2D(
		...
		format,
		type,
		pixels.unsafeAddress().uncheckedCast()
	)
	...
	): Unit = (data as KmlNativeNativeImageData).data.usePinned { dataPin ->
		glTexImage2D(
			target,
			level,
			internalformat,
			...
			format,
			type,
			dataPin.addressOf(0).uncheckedCast()
		)
	}
	...
	override fun texParameterfv(target: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glTexParameterfv(target, pname, params.unsafeAddress().uncheckedCast())
	...
	override fun texParameteriv(target: Int, pname: Int, params: KmlNativeBuffer): Unit =
		glTexParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
	...
	override fun uniform1fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform1fv(location, count, value.unsafeAddress().uncheckedCast())
	...
	override fun uniform1iv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform1iv(location, count, value.unsafeAddress().uncheckedCast())
	...
	override fun uniform2fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform2fv(location, count, value.unsafeAddress().uncheckedCast())
	...
	override fun uniform2iv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform2iv(location, count, value.unsafeAddress().uncheckedCast())
	...
	override fun uniform3fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform3fv(location, count, value.unsafeAddress().uncheckedCast())
	...
	override fun uniform3iv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform3iv(location, count, value.unsafeAddress().uncheckedCast())
	...
	override fun uniform4fv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform4fv(location, count, value.unsafeAddress().uncheckedCast())
	...
	override fun uniform4iv(location: Int, count: Int, value: KmlNativeBuffer): Unit =
		glUniform4iv(location, count, value.unsafeAddress().uncheckedCast())

	override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit =
		glUniformMatrix2fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())

	override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit =
		glUniformMatrix3fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())

	override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: KmlNativeBuffer): Unit =
		glUniformMatrix4fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())
	...
	override fun vertexAttrib1fv(index: Int, v: KmlNativeBuffer): Unit =
		glVertexAttrib1fv(index, v.unsafeAddress().uncheckedCast())
	...
	override fun vertexAttrib2fv(index: Int, v: KmlNativeBuffer): Unit =
		glVertexAttrib2fv(index, v.unsafeAddress().uncheckedCast())
	...
	override fun vertexAttrib3fv(index: Int, v: KmlNativeBuffer): Unit =
		glVertexAttrib3fv(index, v.unsafeAddress().uncheckedCast())
	...
	override fun vertexAttrib4fv(index: Int, v: KmlNativeBuffer): Unit =
		glVertexAttrib4fv(index, v.unsafeAddress().uncheckedCast())
	...
	override fun vertexAttribPointer(
		...
		stride: Int,
		pointer: Int
	): Unit = glVertexAttribPointer(index, size, type, normalized.narrow(), stride, pointer.uncheckedCast())
