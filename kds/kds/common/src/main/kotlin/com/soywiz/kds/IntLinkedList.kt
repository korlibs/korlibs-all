...
class IntLinkedList(private val debug: Boolean) : MutableCollection<Int> {
    //class LinkedList<Int>(private val debug: Boolean) {
    ...
    override fun addAll(elements: Collection<Int>): Boolean = true.apply { ensure(elements.size); for (e in elements) addLast(e) }
