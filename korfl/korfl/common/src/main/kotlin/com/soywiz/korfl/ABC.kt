...
class ABC {
	...
	data class ABCQName(val namespace: Namespace, val name: String) :
		AbstractMultiname {
		override fun toString(): String = "$namespace.$name"
		override val simpleName: String = name
	}

	data class QNameA(val namespace: Namespace, val name: String) :
		AbstractMultiname {
		override val simpleName: String = name
	}
	...
	data class Multiname(val name: String, val namespaceSet: List<Namespace>) :
		AbstractMultiname {
		override val simpleName: String = name
	}

	data class MultinameA(val name: String, val namespaceSet: List<Namespace>) :
		AbstractMultiname {
		override val simpleName: String = name
	}

	data class MultinameL(val namespaceSet: List<Namespace>) :
		AbstractMultiname {
		override val simpleName: String = ""
	}

	data class MultinameLA(val namespaceSet: List<Namespace>) :
		AbstractMultiname {
		override val simpleName: String = ""
	}
	...
	val namespaces: List<Namespace> get() = cpool.namespaces
	val namespaceSets: List<List<Namespace>> get() = cpool.namespaceSets
	val multinames: List<AbstractMultiname> get() = cpool.multinames
	...
	data class TraitMethod(override val name: AbstractMultiname, val dispIndex: Int, val methodIndex: Int) :
		Trait
	data class TraitClass(override val name: AbstractMultiname, val slotIndex: Int, val classIndex: Int) :
		Trait
	data class TraitFunction(override val name: AbstractMultiname, val slotIndex: Int, val functionIndex: Int) :
		Trait
