...
enum class AbcOpcode(val id: Int, val type: Kind) {
...
data class AbcLabelOperation(override val opcode: AbcOpcode, val position: Long) :
	AbcOperation

data class AbcLookupSwitchOperation(override val opcode: AbcOpcode, val defaultMarker: Long, val markers: LongArray) :
	AbcOperation

data class AbcIntStringIntIntOperation(
	override val opcode: AbcOpcode,
	val int1: Int,
	val string: String,
	val int2: Int,
	val int3: Int
...
data class AbcIntOperation(override val opcode: AbcOpcode, val value: Int) :
	AbcOperation

data class AbcJumpOperation(override val opcode: AbcOpcode, val position: Long) :
	AbcOperation

data class AbcStringOperation(override val opcode: AbcOpcode, val value: String) :
	AbcOperation

data class AbcIntIntOperation(override val opcode: AbcOpcode, val value1: Int, val value2: Int) :
	AbcOperation

data class AbcDoubleOperation(override val opcode: AbcOpcode, val value: Double) :
	AbcOperation

data class AbcNewClassOperation(override val opcode: AbcOpcode, val value: Int) :
	AbcOperation

data class AbcMultinameOperation(override val opcode: AbcOpcode, val multiname: ABC.AbstractMultiname) :
	AbcOperation

data class AbcMultinameIntOperation(
	override val opcode: AbcOpcode,
	val multiname: ABC.AbstractMultiname,
	val value: Int
) : AbcOperation

data class AbcNamespaceOperation(override val opcode: AbcOpcode, val namespace: ABC.Namespace) :
	AbcOperation
