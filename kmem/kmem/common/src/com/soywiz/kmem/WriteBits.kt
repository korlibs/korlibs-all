...
fun ByteArray.writeArray_le(o: Int, array: CharArray) =
	writeTypedArray(o, 2, array.indices) { p, n -> write16_le(p, array[n].toInt()) }

fun ByteArray.writeArray_le(o: Int, array: ShortArray) =
	writeTypedArray(o, 2, array.indices) { p, n -> write16_le(p, array[n].toInt()) }

fun ByteArray.writeArray_le(o: Int, array: IntArray) =
	writeTypedArray(o, 4, array.indices) { p, n -> write32_le(p, array[n]) }

fun ByteArray.writeArray_le(o: Int, array: LongArray) =
	writeTypedArray(o, 8, array.indices) { p, n -> write64_le(p, array[n]) }

fun ByteArray.writeArray_le(o: Int, array: FloatArray) =
	writeTypedArray(o, 4, array.indices) { p, n -> writeF32_le(p, array[n]) }

fun ByteArray.writeArray_le(o: Int, array: DoubleArray) =
	writeTypedArray(o, 8, array.indices) { p, n -> writeF64_le(p, array[n]) }

fun ByteArray.writeArray_be(o: Int, array: CharArray) =
	writeTypedArray(o, 2, array.indices) { p, n -> write16_be(p, array[n].toInt()) }

fun ByteArray.writeArray_be(o: Int, array: ShortArray) =
	writeTypedArray(o, 2, array.indices) { p, n -> write16_be(p, array[n].toInt()) }

fun ByteArray.writeArray_be(o: Int, array: IntArray) =
	writeTypedArray(o, 4, array.indices) { p, n -> write32_be(p, array[n]) }

fun ByteArray.writeArray_be(o: Int, array: LongArray) =
	writeTypedArray(o, 8, array.indices) { p, n -> write64_be(p, array[n]) }

fun ByteArray.writeArray_be(o: Int, array: FloatArray) =
	writeTypedArray(o, 4, array.indices) { p, n -> writeF32_be(p, array[n]) }

fun ByteArray.writeArray_be(o: Int, array: DoubleArray) =
	writeTypedArray(o, 8, array.indices) { p, n -> writeF64_be(p, array[n]) }
