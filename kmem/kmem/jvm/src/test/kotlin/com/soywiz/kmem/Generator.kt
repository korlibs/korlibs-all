...
object Generator {
	val AUTOGEN_NOTICE =
		"@WARNING: File AUTOGENERATED by `src/test/kotlin/com.soywiz.kmem.Generator.kt` @ korlibs/kmem do not modify manually!"
	...
	fun main(args: Array<String>) {
		...
		File("kmem/common/src/com.soywiz.kmem.main/kotlin/com/soywiz/kmem/KmemGen.kt").writeText(
			generateCommon().joinToString(
				"\n"
			)
		)
		File("kmem/js/src/com.soywiz.kmem.main/kotlin/com/soywiz/kmem/KmemGenJs.kt").writeText(
			generateJs().joinToString(
				"\n"
			)
		)
		File("kmem/jvm/src/com.soywiz.kmem.main/kotlin/com/soywiz/kmem/KmemGenJvm.kt").writeText(
			generateJvm().joinToString(
				"\n"
			)
		)
	}
