...
fun ByteBuffer.slice(offset: Int, size: Int): ByteBuffer = run {
	val out = this.duplicate(); out.position(this.position() + offset); out.limit(out.position() + size); return out
}
...
actual fun MemBufferAlloc(size: Int): MemBuffer =
	MemBuffer(ByteBuffer.allocate((size + 0xF) and 0xF.inv()).order(ByteOrder.nativeOrder()), size)

actual fun MemBufferWrap(array: ByteArray): MemBuffer =
	MemBuffer(ByteBuffer.wrap(array).order(ByteOrder.nativeOrder()), array.size)

actual inline val MemBuffer.size: Int get() = this.size

actual fun MemBuffer._sliceInt8Buffer(offset: Int, size: Int): Int8Buffer =
	Int8Buffer(this, this.buffer.slice(offset, size))

actual fun MemBuffer._sliceInt16Buffer(offset: Int, size: Int): Int16Buffer =
	Int16Buffer(this, this.buffer.asShortBuffer().slice(offset, size))

actual fun MemBuffer._sliceInt32Buffer(offset: Int, size: Int): Int32Buffer =
	Int32Buffer(this, this.buffer.asIntBuffer().slice(offset, size))

actual fun MemBuffer._sliceFloat32Buffer(offset: Int, size: Int): Float32Buffer =
	Float32Buffer(this, this.buffer.asFloatBuffer().slice(offset, size))

actual fun MemBuffer._sliceFloat64Buffer(offset: Int, size: Int): Float64Buffer =
	Float64Buffer(this, this.buffer.asDoubleBuffer().slice(offset, size))
...
actual fun arraycopy(src: MemBuffer, srcPos: Int, dst: MemBuffer, dstPos: Int, size: Int): Unit =
	run { dst.buffer.slice(dstPos, size).put(src.buffer.slice(srcPos, size)) }

actual fun arraycopy(src: ByteArray, srcPos: Int, dst: MemBuffer, dstPos: Int, size: Int): Unit =
	run { (dst.sliceInt8Buffer(dstPos, size) as Int8Buffer).jbuffer.put(src, srcPos, size) }

actual fun arraycopy(src: MemBuffer, srcPos: Int, dst: ByteArray, dstPos: Int, size: Int): Unit =
	run { (src.sliceInt8Buffer(srcPos, size) as Int8Buffer).jbuffer.get(dst, dstPos, size) }

actual fun arraycopy(src: ShortArray, srcPos: Int, dst: MemBuffer, dstPos: Int, size: Int): Unit =
	run { (dst.sliceInt16Buffer(dstPos, size) as Int16Buffer).jbuffer.put(src, srcPos, size) }

actual fun arraycopy(src: MemBuffer, srcPos: Int, dst: ShortArray, dstPos: Int, size: Int): Unit =
	run { (src.sliceInt16Buffer(srcPos, size) as Int16Buffer).jbuffer.get(dst, dstPos, size) }

actual fun arraycopy(src: IntArray, srcPos: Int, dst: MemBuffer, dstPos: Int, size: Int): Unit =
	run { (dst.sliceInt32Buffer(dstPos, size) as Int32Buffer).jbuffer.put(src, srcPos, size) }

actual fun arraycopy(src: MemBuffer, srcPos: Int, dst: IntArray, dstPos: Int, size: Int): Unit =
	run { (src.sliceInt32Buffer(srcPos, size) as Int32Buffer).jbuffer.get(dst, dstPos, size) }

actual fun arraycopy(src: FloatArray, srcPos: Int, dst: MemBuffer, dstPos: Int, size: Int): Unit =
	run { (dst.sliceFloat32Buffer(dstPos, size) as Float32Buffer).jbuffer.put(src, srcPos, size) }

actual fun arraycopy(src: MemBuffer, srcPos: Int, dst: FloatArray, dstPos: Int, size: Int): Unit =
	run { (src.sliceFloat32Buffer(srcPos, size) as Float32Buffer).jbuffer.get(dst, dstPos, size) }

actual fun arraycopy(src: DoubleArray, srcPos: Int, dst: MemBuffer, dstPos: Int, size: Int): Unit =
	run { (dst.sliceFloat64Buffer(dstPos, size) as Float64Buffer).jbuffer.put(src, srcPos, size) }

actual fun arraycopy(src: MemBuffer, srcPos: Int, dst: DoubleArray, dstPos: Int, size: Int): Unit =
	run { (src.sliceFloat64Buffer(srcPos, size) as Float64Buffer).jbuffer.get(dst, dstPos, size) }

@PublishedApi
actual internal fun <T> _fill(array: Array<T>, value: T, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)

@PublishedApi
actual internal fun _fill(array: BooleanArray, value: Boolean, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)

@PublishedApi
actual internal fun _fill(array: LongArray, value: Long, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)

@PublishedApi
actual internal fun _fill(array: ByteArray, value: Byte, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)

@PublishedApi
actual internal fun _fill(array: ShortArray, value: Short, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)

@PublishedApi
actual internal fun _fill(array: IntArray, value: Int, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)

@PublishedApi
actual internal fun _fill(array: FloatArray, value: Float, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)

@PublishedApi
actual internal fun _fill(array: DoubleArray, value: Double, start: Int, end: Int): Unit =
	Arrays.fill(array, start, end, value)
