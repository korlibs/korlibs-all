...
class RGBA(val rgba: Int) {
	...
	operator fun plus(other: RGBA) = RGBA(this.r + other.r, this.g + other.g, this.b + other.b, this.a + other.a)
	operator fun minus(other: RGBA) = RGBA(this.r - other.r, this.g - other.g, this.b - other.b, this.a - other.a)

	companion object : ColorFormat32() {
		@JvmStatic
		//operator fun invoke(r: Int, g: Int, b: Int, a: Int) = pack(r, g, b, a)
		operator fun invoke(r: Int, g: Int, b: Int, a: Int) =
